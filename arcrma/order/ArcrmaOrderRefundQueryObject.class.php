<?php
	 ...
	 * refund_no		string	20	交易日期				N
	 */
	class ArcrmaOrderRefundQueryObject extends ArcrmaAbstractOrder {
		public $store = null;
		public $pno = null;
		public $refund_no = null;
		private $_valided = false;
		private $required_fields = array('store', 'pno');
		...
		private function validRefundNo($check) {
